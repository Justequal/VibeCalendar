...
(function exposeTranslations(root) {
  root.VibeCalendarTranslations = Object.freeze({
    'zh-CN': Object.freeze({
      ...
      updateDownloaded: 'v{version} 下载完成，可快速重启更新',
      updateNow: '快速重启更新 V{version}',
      updating: '正在快速重启…',
      upToDate: '当前已是最新版本',
      updateCheckError: '检查失败，重试',
      releaseTitle: '当前版本说明',
      releaseLoading: '正在加载…',
    ...
    en: Object.freeze({
      ...
      updateDownloaded: 'v{version} downloaded; quick restart available',
      updateNow: 'Quick restart to update V{version}',
      updating: 'Restarting to update…',
      upToDate: 'You are using the latest version',
      updateCheckError: 'Check failed · Retry',
